...
#define USAGE   "testAdvect [-P P] [-x] [-v v] M N r"
#define DEFAULTS "P=r=1 v=0"
#define OPTCHARS "P:xv:"

static int M, N;               // advection field size
static int P=1, Q;             // PxQ decomposition, Q = nprocs / P
...
int main(int argc, char** argv) {
  ...
  ldu = M+2;
  u = calloc(ldu*(N+2), sizeof(double));
  ...
  printf("Advection time %.3e, GFLOPs rate=%.2e (per core %.2e)\n",
